...
namespace SistemaGEISA
{
    public partial class frmObrasNew : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            luResidente.Properties.DataSource = controler.Model.Empleado.Where(D => D.Activo == true && D.EsResidente == true).ToList();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (isValid())
            {
                ...
                obra.Empleado = controler.GetObjectFromContext(luResidente.GetSelectedDataRow() as Empleado);
