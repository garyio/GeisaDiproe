...
namespace GeisaBD
{
    public partial class CajaChicaComprobante
    {
        ...
        {
            CajaChicaComprobante that = obj as CajaChicaComprobante;
            return that != null && ((this.Id == that.Id && this._Id != 0) || (base.Equals(that)));
        }

        public static bool operator ==(CajaChicaComprobante obj1, CajaChicaComprobante obj2)
        {
